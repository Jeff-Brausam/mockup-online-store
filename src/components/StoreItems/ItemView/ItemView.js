  ...
  return (
    <div className={classes.ItemView}>
      <span>
        ...
        <button className={classes.Close} onClick={props.clicked}>
          X
        </button>
      </span>
      ...
      <p>
        <strong>${props.items.price.toLocaleString()}</strong>
      </p>
      <hr />
      ...
      <span>
        ...
        <Button
          ...
          clicked={() => props.addToCart(props.items.itemID)}>
          Add To Cart
        </Button>
        <Button btnType="ViewItemCheckout" clicked={props.toCheckout}>
          Checkout
        </Button>
      </span>
    </div>
